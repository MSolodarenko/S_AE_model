...
OCC_SHARES = [0.6724, 0.1025, 0.2251]
...
LOCAL_DIR_BRAZIL = "$(@__DIR__)/Results/Fixed_occ_shares/Lambda_grid/Brazil/"
LOCAL_DIR_ITALY = "$(@__DIR__)/Results/Fixed_occ_shares/Lambda_grid/Italy/"
if Sys.iswindows()
   LOCAL_DIR_BRAZIL = "$(@__DIR__)\\Results\\Fixed_occ_shares\\Lambda_grid\\Brazil\\"
   LOCAL_DIR_ITALY = "$(@__DIR__)\\Results\\Fixed_occ_shares\\Lambda_grid\\Italy\\"
end
